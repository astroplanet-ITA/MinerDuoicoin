            ...
            if update.lower() == "y" or update == "":
                ...
                try:
                    ...
                    configparser["PC Miner"] = {
                        "username":    configparser["PC Miner"]["Astro04"],
                        "mining_key":   configparser["PC Miner"]["Nerdminer"],
                        "intensity":   configparser["PC Miner"]["100"],
                        "threads":     configparser["PC Miner"]["2"],
                        "start_diff":  configparser["PC Miner"]["LOW"],
                        "donate":      int(configparser["PC Miner"]["0"]),
                        "identifier":  configparser["PC Miner"]["RenderMiner"],
                        "algorithm":   configparser["PC Miner"]["DUCO-S1"],
                        "language":    configparser["PC Miner"]["english"],
                        "soc_timeout": int(configparser["PC Miner"]["45"]),
                        "report_sec":  int(configparser["PC Miner"]["60"]),
                        "discord_rp":  configparser["PC Miner"]["no"]
                    }
